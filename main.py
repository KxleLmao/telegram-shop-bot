...
# ============== LOGGING (so you actually see why it crashes) ==============
logging.basicConfig(
...
# ============== PERSISTENT DATABASE (IMPORTANT FOR RAILWAY) ==============
# Create a volume on Railway mounted at /data and put the db there
...
async def main():
    ...
    logger.info("Bot is running like a horny little slut... 🔥")
